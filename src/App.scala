import exceptions.{InvalidGaussMatrixException, InvalidMatrixException, InvalidSystemOfLinearEquationsMatrixException, NoUniqueSolutionException}
...
object App {
  def main(args: Array[String]): Unit = {
    try {
      ...
      case ex: InvalidGaussMatrixException => println("System of Linear Equation not resolver y Gauss Method")
