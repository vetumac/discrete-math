...
object Integr {
  ...
  def apply(func: String, a: Double, b: Double, d: Double): Double = {
    ...
    def simpson(func: String, a: Double, b: Double, d: Double, n: Int, prevRes: Double, evaluator: Evaluator): Double = {
      val h = (b - a) / (2 * n)
    ...
    def evaluate(func: String, x: Double, evaluator: Evaluator): Double = {
